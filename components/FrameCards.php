...
<?php
  /* Template Name: Frame */
    ...
    <div id="default-tab-content">
        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 md:w-[70%] md:mx-auto md:flex md:items-center md:justify-center" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        <form action="http://localhost/wordpress/checkout/" id="imageUpload" method="post">
          <div class="flex items-center justify-center">
           ...
           <!-- Replace the existing file input and label with the custom button -->
          <label for="imageInputTwo" class="flex items-center justify-center">
              <strong class="font-bold text-6xl text-brand">+</strong>
          </label>
...
// Add this code to handle the click event on the custom button
// const customButton = document.querySelector('label[for="imageInputTwo"]');
